- [DigitalOcean deployment](deployment-digitalocean.md) — live server is DO only; never suggest Railway/Replit publish; always end with "Pull and restart on DigitalOcean".
